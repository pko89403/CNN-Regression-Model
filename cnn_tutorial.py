...
# 3 X 3 is Filter size -> Convolutional Size 3 X 3
w = init_weights([3, 3, 1, 32])             # 3 X 3 X 1 dimension input tensor 32 is number of feature maps.
w2 = init_weights([3, 3, 32, 64])           # input size increase as 32. 3 X 3 X 32 nodes
w3 = init_weights([3, 3, 64, 128])          # 64 is output feature number. 3 X 3 X 64
w4 = init_weights([128 * 4 * 4, 625])       # receives input 128 X 4 X 4 , output is 625
